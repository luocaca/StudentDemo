...
public class LocationUtils_new {


    private volatile static LocationUtils_new uniqueInstance;
    private LocationHelper mLocationHelper;
    private MyLocationListener myLocationListener;
    private LocationManager mLocationManager;
    private Context mContext;

    private LocationUtils_new(Context context) {
        mContext = context;
    ...
    public static LocationUtils_new getInstance(Context context) {
        if (uniqueInstance == null) {
            synchronized (LocationUtils.class) {
                if (uniqueInstance == null) {
                    uniqueInstance = new LocationUtils_new(context);
                }
            }
        }
    ...
    public void initLocation(LocationHelper locationHelper) {
        ...
        if (mLocationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            ...
            Log.e("MoLin", "LocationManager.NETWORK_PROVIDER" + Thread.currentThread().getName());
            if (location != null) {
